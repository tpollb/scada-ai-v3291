...
- Увеличен таймаут HTTP-клиента до 180 секунд для долгих запросов к БД/LLM
- Исправлены дубликаты импортов в Home.svelte
- Добавлен блок "Лицензия" в правый сайдбар Home.svelte

### 📚 Документация
- Обновлён README.md с информацией о системе лицензирования
- Добавлен LICENSING.md в whitelist docs.py для отображения в UI
- Обновлены версии во всех файлах документации

### 🔧 Технические улучшения
- Переход на customFetch в api.ts для надёжного перехвата HTTP-ошибок
- Добавлена обработка HTTP 402/403 на фронтенде
- Улучшена стабильность работы с long-running запросами
